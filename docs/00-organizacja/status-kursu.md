# Status kursu Python od podstaw
...
- OK — `README.md` — zawiera linki do lekcji.
- OK — `01-pierwszy-program.md` — lekcja uzupełniona.
- OK — `02-print.md` — lekcja uzupełniona.
- OK — `03-zmienne.md` — lekcja uzupełniona.
- OK — `04-typy-danych.md` — lekcja uzupełniona.
- OK — `05-komentarze.md` — lekcja uzupełniona.
- OK — `06-operatory.md` — lekcja uzupełniona.
...
- OK — `README.md` — zawiera linki do projektów.
- OK — `01-kalkulator.md` — projekt uzupełniony.
